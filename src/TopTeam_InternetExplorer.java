...
public class TopTeam_InternetExplorer
{
	...
	public static void main(String[] args) throws Throwable
	{
		...
		try
		{
			...
			if(Password1)
			{
				JOptionPane.showMessageDialog(null,"Sorry, your username or password are incorrect, Please correct in the config excel and try again","ERROR",JOptionPane.ERROR_MESSAGE);
				driver.quit();
				System.exit(1);
			}
